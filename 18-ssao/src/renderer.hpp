...
class OpenGLRenderer {
    ...
    std::unique_ptr<GLGraphicsShaders> prepassShaders;
    std::unique_ptr<GLGraphicsShaders> ssaoShaders;
    ...
    GLuint prepassPositionTextureID;
    GLuint prepassNormalTextureID;
    GLuint prepassDepthTextureID;

    GLuint blurTemporaryTextureID;

    GLuint ssaoTextureID;
    GLuint ssaoSampleNoiseTextureID;
    ...
    static constexpr size_t SSAO_SAMPLE_COUNT = 64;
    std::array<glm::vec3, SSAO_SAMPLE_COUNT> ssaoSamples;
